...
def make_terminal(theme, temp="--°C", condition="Loading...", emoji="🌡️", timestamp="--:-- UTC"):
    ...
    LINES = [
        ...
        ("out",    [("out", "By day: "), ("green", "Statens vegvesen"), ("out", ". By night: "), ("blue", "USN, IT & IS"), ("out", ".")]),
        ...
        ("out",    [("out", "{")]),
        ("out",    [("out", "  "), ("key", '"weather"'), ("out", ":  "), ("val", f'"{emoji} {temp} \u00b7 {condition} \u00b7 {timestamp}"'), ("out", ",")]),
        ("out",    [("out", "  "), ("key", '"status"'),  ("out", ":   "), ("green", '"open to interesting conversations"')]),
        ("out",    [("out", "}")]),
        ("blank",  []),
